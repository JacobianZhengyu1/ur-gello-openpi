...
class UR5E(Robot):
    ...
    def connect(self, calibrate: bool = True) -> None:
        ...
        try:
            ...
            print("skip speed calibration")

            self.gripper._openbit = 0
            self.gripper._closebit = 255

            self.gripper._gripper_vmin_bits = 0.05
            self.gripper._gripper_vmax_bits = 1.0

            self.gripper._is_bit_calibrated = True
            self.gripper._is_speed_calibrated = True

            print("manual gripper calibration loaded")
    ...
    def send_action(self, action: dict[str, float]) -> dict[str, float]:
        ...
        new_pos = int(goal_gripper_position)
